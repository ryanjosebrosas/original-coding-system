# Plan Feature: GitHub Issue #$ISSUE_NUMBER
...
**Create User Story Format Or Refine If Story Was Provided:**
...
- If requirements are unclear at this point, note them in the plan
...
- Estimated confidence score for one-pass success (X/10)
