...
If no purpose is provided, ask user: "What should this agent do? Describe the task it will handle (e.g., 'review code for accessibility issues', 'research API documentation for a framework')."

## Step 1: Determine Agent Type

Based on purpose description, classify the agent:
...
Generate a kebab-case name from purpose:
...
Read `.opencode/agents/_examples/research-codebase.md` as a structural reference.
...
- Reminder: "Restart your OpenCode session or start a new conversation to load the new agent"
