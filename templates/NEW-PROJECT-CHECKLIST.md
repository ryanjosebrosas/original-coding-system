...
- [ ] Run `/init-c` to generate your AGENTS.md (or copy and fill in manually)
- [ ] Use the PRD to inform tech stack, architecture, and convention decisions
- [ ] Review the generated AGENTS.md — does it match your project?
...
- [ ] Git commit your AGENTS.md

See the example AGENTS.md structure in your project's `sections/` directory for reference.
...
- [ ] Add references to your AGENTS.md so the AI knows when to load them
...
- [ ] Validate no contradictions between PRD, AGENTS.md, and reference guides
